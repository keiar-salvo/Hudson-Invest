    ...
    public function up(): void
    {
        Schema::create('liabilities__non__investments', function (Blueprint $table) {
           $table->string('details_id')->unique();
            ...
            $table->string('total_non_invesment_liabilities_market_value')->nullable();
            $table->string('total_non_invesment_liabilities_client')->nullable();
            $table->string('total_non_invesment_liabilities_partner')->nullable();
