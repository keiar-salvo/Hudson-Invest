...
<div :class="{'dark text-white-dark' : $store.app.semidark}">
        ...
        <div class="h-full bg-white dark:bg-[#0e1726]">
            <div class="flex items-center justify-between px-4 py-3">
                <a href="" class="main-logo flex shrink-0 items-center">
                   ...
                   <img src="/assets/images/auth/hudson-invest-small.png" alt="Cover Image" class="w-full">
                </a>
         
            </div>
            <ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto overflow-x-hidden p-4 py-0 font-semibold" x-data="{ activeDropdown: 'form' }">
            
            <h2 class="-mx-4 mb-1 flex items-center bg-white-light/30 px-7 py-3 font-extrabold uppercase dark:bg-dark dark:bg-opacity-[0.08]" style="background-color:#bd0c1d;color:white;">
                 ...
                 <li class=" nav-item">
                  <ul>
                     <li class="nav-item">
                         <a href="{{ route('clientlist') }}" class="{{ set_active(['clientlist']) }}  group">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Client List</span>
                                </div>
                            </a>
                     </li>
                 ...
                 <li class=" nav-item">
                  <ul>
                     <li class="nav-item">
                         <a href="{{ route('details') }}" class="{{ set_active(['details']) }}">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Client Details</span>
                                </div>
                            </a>
                     </li>
                      <!-- <li class="nav-item">
                      ...
                      <!-- <li class="nav-item verifiedToOpen">
                         <a href="{{ route('income') }}" class="{{ set_active(['income']) }} m-income">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Income</span>
                                </div>
                            </a>
                     </li>
                       <li class="nav-item verifiedToOpen">
                         <a href="{{ route('contribution') }}" class="{{ set_active(['contribution']) }}">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Contributions</span>
                                </div>
                            </a>
                     </li>
                     <li class="nav-item verifiedToOpen">
                         <a href="{{ route('assets-liabilities') }}" class="{{ set_active(['assets-liabilities']) }}">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Assets & Liabilities</span>
                                </div>
                            </a>
                     </li>
                      <li class="nav-item verifiedToOpen">
                         <a href="{{ route('estimation') }}" class="{{ set_active(['estimation']) }}">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">PAYG Estimation</span>
                                </div>
                            </a>
                     </li>
                    <li class="nav-item verifiedToOpen">
                         <a href="{{ route('debt-rates') }}" class="{{ set_active(['debt-rates']) }}">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Debt Rates</span>
                                </div>
                            </a>
                     </li>
                        ...
                        <li class="nav-item">
                            <a href="#" class=" group">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Initial Client Po's Graph</span>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class=" group">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Client New IP Graph</span>
                                </div>
                            </a>
                        </li>
                            ...
                            <a href="#" class=" group">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Client Po's with IP Graph</span>
                                </div>
                            </a>
                        </li>
                    </ul>
                ...
                <li class=" nav-item">
                    <ul>
                        <li class="nav-item">
                            <a href="{{ route('assumptionrates') }}" class="{{ set_active(['assumptionrates']) }}">
                                <div class="flex items-center">
  ...
  <path d="M9.796 1.343c-.527-1.79-3.065-1.79-3.592 0l-.094.319a.873.873 0 0 1-1.255.52l-.292-.16c-1.64-.892-3.433.902-2.54 2.541l.159.292a.873.873 0 0 1-.52 1.255l-.319.094c-1.79.527-1.79 3.065 0 3.592l.319.094a.873.873 0 0 1 .52 1.255l-.16.292c-.892 1.64.901 3.434 2.541 2.54l.292-.159a.873.873 0 0 1 1.255.52l.094.319c.527 1.79 3.065 1.79 3.592 0l.094-.319a.873.873 0 0 1 1.255-.52l.292.16c1.64.893 3.434-.902 2.54-2.541l-.159-.292a.873.873 0 0 1 .52-1.255l.319-.094c1.79-.527 1.79-3.065 0-3.592l-.319-.094a.873.873 0 0 1-.52-1.255l.16-.292c.893-1.64-.902-3.433-2.541-2.54l-.292.159a.873.873 0 0 1-1.255-.52zm-2.633.283c.246-.835 1.428-.835 1.674 0l.094.319a1.873 1.873 0 0 0 2.693 1.115l.291-.16c.764-.415 1.6.42 1.184 1.185l-.159.292a1.873 1.873 0 0 0 1.116 2.692l.318.094c.835.246.835 1.428 0 1.674l-.319.094a1.873 1.873 0 0 0-1.115 2.693l.16.291c.415.764-.42 1.6-1.185 1.184l-.291-.159a1.873 1.873 0 0 0-2.693 1.116l-.094.318c-.246.835-1.428.835-1.674 0l-.094-.319a1.873 1.873 0 0 0-2.692-1.115l-.292.16c-.764.415-1.6-.42-1.184-1.185l.159-.291A1.873 1.873 0 0 0 1.945 8.93l-.319-.094c-.835-.246-.835-1.428 0-1.674l.319-.094A1.873 1.873 0 0 0 3.06 4.377l-.16-.292c-.415-.764.42-1.6 1.185-1.184l.292.159a1.873 1.873 0 0 0 2.692-1.115z"/>
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Assumption Rates</span>
                                </div>
                            </a>
                        </li>
